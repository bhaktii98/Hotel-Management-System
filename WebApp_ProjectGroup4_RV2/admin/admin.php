...
<body>
    ...
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn"><img src="../image/icon/staff.png">&nbsp&nbsp&nbsp Food</li>
    ...
    <div class="mainscreen">
        ...
        <iframe class="frames frame4" src="./fadmin.php" frameborder="0"></iframe>
    </div>
</body>
