...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2023 at 11:26 PM
...
(6, 'satvik', 1, 0x6261636b67726f756e642e6a7067, 1),
(7, 'bhakti', 14, 0x6261636b67726f756e642e6a7067, 1);
...
(1, 'satvik', 1, 0x6261636b67726f756e642e6a7067),
(2, 'bhakti', 14, 0x6261636b67726f756e642e6a7067);
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `fk_order_user` FOREIGN KEY (`UserID`) REFERENCES `signup` (`UserID`);
COMMIT;
